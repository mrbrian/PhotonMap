...
ImagePlane::ImagePlane(Point3D a, Point3D b, Point3D c, Point3D d)
{
...
void ImagePlane::Transform(Matrix4x4 m)
{
    for (int i = 0; i < 4 ;i ++)
    {
        points[i] = m * points[i];
...
Point3D ImagePlane::ImageToWorldSpace(int x, int y, int imgWidth, int imgHeight)
{
